...
<div class="row">
    <div class="col-xl-12 col-lg-12">
        <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="name" class="form-control" type="text" name="phone" value="{{ $data->phone }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="username" class="form-control" type="text" name="username" value="{{ $data->username }}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div>
                <button class="btn btn-primary btn-block shadow-sm py-2" type="submit">Simpan Perubahan</button>
            </div>
        </form>
    </div>
</div>
