...
<div class="attendance-view">
    <div class="card-box">
        ...
        <div id="demo" class="text-center py-4 my-4" style="border-radius: 10px;"></div>
        <div id="googleMap" class="text-center py-4 my-4" style="border-radius: 10px; height: 250px;"></div>
...
@push('addon-script')
<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=true&v=3&libraries=geometry"></script>
<script>
