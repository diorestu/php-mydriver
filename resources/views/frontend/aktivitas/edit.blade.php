...
<div class="add-leave">
    ...
    <div class="navbar two-action no-hairline">
        <div class="navbar-inner d-flex align-items-center justify-content-between">
            ...
            <div class="sliding custom-title">Update Aktivitas</div>
            <div class="right">
            </div>
        </div>
    </div>
        ...
        <div class="list no-hairlines custom-form">
            <div class="card-box">
                <ul class="no-border pt-0 pb-0">
                    <form method="post" action="{{ route('aktivitas.update', $item->id) }}" enctype="multipart/form-data">
                        @method('put')
                        @csrf
                        ...
                        <li class="item-content item-input">
                            <div class="item-inner">
                                ...
                                <div class="item-input-wrap">
                                    <textarea id="my-textarea" class="form-control" name="deskripsi" rows="4"
                                        required></textarea>
                                </div>
                            </div>
                        </li>
                        <li class="item-content item-input">
                            <div class="item-inner">
                                <div class="item-title item-label">Kilometer Awal</div>
                                <div class="item-input-wrap">
                        ...
                        <li class="item-content item-input">
                            <div class="item-inner">
                                <div class="item-title item-label">Kilometer Akhir</div>
                                <div class="item-input-wrap">
                        ...
                        <li class="item-content item-input">
                            <div class="item-inner">
                                ...
                                <div class="item-input-wrap">
                                    <input id="my-input" class="form-control-file" accept="image/*"
                                        accept="image/*;capture=camera" capture type="file" name="photo">
                                </div>
                            </div>
                        </li>
                        <li class="item-content item-input">
                        ...
                        <li class="item-content item-input">
                            <div class="item-inner">
                                <div class="item-input-wrap">
                                    <button type="submit" class="button button-big button-purple py-3">Tandai Selesai</button>
                                </div>
                            </div>
                        </li>
                    </form>
